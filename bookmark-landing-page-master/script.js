...
tabBtn[0].addEventListener("click", () => {
    one.style.cssText = "display: flex"
...
tabBtn[1].addEventListener("click", () => {
    two.style.cssText = "display: flex"
    three.style.cssText = "display: none"
...
tabBtn[2].addEventListener("click", () => {
    three.style.cssText = "display: flex"
    one.style.cssText = "display: none"
    two.style.cssText = "display: none"
